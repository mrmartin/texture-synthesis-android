...
public class TiledBitmapView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private static final String STATEKEY_SUPERCLASS = "com.mrmartin.tbv.super";
    private static final String STATEKEY_DEBUG_ENABLED = "com.mrmartin.tbv.debugenabled";
     ...
     * {@link com.mrmartin.tbv.TileProvider#getConfigGridAnchor()} implementation.
     *
    ...
    class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            requestSurfaceRefresh(true); // or true? Will result in second call to the provider
