 ...
 */
package net.martaskolda.meep.tbv;
...
public class TiledBitmapView extends SurfaceView implements SurfaceHolder.Callback {
     ...
     * {@link TileProvider#getConfigGridAnchor()} implementation.
     *
            ...
            for (Tile[] tileRow : visibleTiles) {
                ...
                for (Tile t : tileRow) {
                    ...
                    if (debugEnabled) {
                        ...
                        //canvas.drawText(msg1, curTileLeft + (state.tileWidth / 2), curTileTop + (state.tileWidth / 2), paint_debugTileTxt);
                    }
