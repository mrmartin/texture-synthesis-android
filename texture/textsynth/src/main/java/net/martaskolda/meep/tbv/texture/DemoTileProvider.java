...
import net.martaskolda.meep.tbv.GenericTileProvider;
import net.martaskolda.meep.tbv.Tile;
import net.martaskolda.meep.tbv.TileProvider;
import net.martaskolda.meep.tbv.TileRange;
import net.martaskolda.meep.tbv.TiledBitmapView;
import net.martaskolda.meep.tbv.Utils;
 ...
 * {@link #onTileIDRangeChange(TileRange)} I create a queue of the tiles needed to fill
...
public class DemoTileProvider extends GenericTileProvider {
    ...
    public boolean use_captured_bmp = false;
    public Bitmap captured_bmp;
    ...
    class QueueProcessTask implements Runnable {
        ...
        public void run() {
            ...
            while (!renderQueue.isEmpty()) {
                ...
                String resName = "marble";

                Bitmap bmp;
                if(use_captured_bmp) {
                    bmp = captured_bmp;
                }else {
                    bmp = resCache.get(resName);
                }
